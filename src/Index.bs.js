...
function Index$UnnamedQuery1(Props) {
  ...
  if (full[/* loading */1]) {
    ...
    var title = Belt_Option.map(Belt_Option.map(Belt_Option.map(data, (function (data) {
                    return data.rss;
                  })), (function (rss) {
                return rss.rss2Feed;
              })), (function (rss2Feed) {
            return rss2Feed.title;
          }));
    var items = Belt_Option.map(Belt_Option.map(Belt_Option.map(data, (function (data) {
                    return data.rss;
                  })), (function (rss) {
                return rss.rss2Feed;
              })), (function (rss2Feed) {
            return rss2Feed.items;
          }));
    return React.createElement("div", undefined, React.createElement("div", undefined, Belt_Option.getWithDefault(title, "")), React.createElement("div", undefined, Belt_Array.map(Belt_Option.getWithDefault(items, /* array */[]), (function (item) {
                          return React.createElement("iframe", {
                                      src: Belt_Option.getWithDefault(item.link, "")
                                    });
...
function Index$Podcast(Props) {
  return React.createElement(Index$UnnamedQuery1, { });
}

var Podcast = /* module */[/* make */Index$Podcast];
...
ReactDOMRe.renderToElementWithId(React.createElement(ReactHooks.ApolloProvider, {
          client: client,
          children: null
        }, React.createElement(App$ReactHooksTemplate.make, {
              greeting: "Hello, ReasonConf Dojo"
            }), React.createElement(Index$Podcast, { })), "index1");
